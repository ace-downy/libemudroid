...
{
	public static final String TAG = EmulatorService.class.getSimpleName();
	...
	void handleCommand(Intent intent)
	{
		if (ACTION_FOREGROUND.equals(intent.getAction()))
		{
			...
			try
			{
				...
				Notification notification = new NotificationCompat.Builder(this, "EmulatorService")
			...
			{
				Log.e(TAG, "could not start service in foreground", e);
			}
